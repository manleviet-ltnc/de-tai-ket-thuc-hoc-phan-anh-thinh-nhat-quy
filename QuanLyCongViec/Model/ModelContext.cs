...
namespace QuanLyCongViec.Model
{
    ...
    {
        public static List<CongViec> CongViecs = new List<CongViec>()
                   {
                        ...
                        new CongViec() { ID = 5, Ten = "Thi Mạng Và Truyền Thông", BatDau = DateTime.Now, KetThuc = DateTime.Now, TrangThai = 1 }
                   };
